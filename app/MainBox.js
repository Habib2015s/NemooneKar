  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-8 items-start">
        {/* سمت راست (کارت سید حبیب الله موسوی) - اول در موبایل، دوم در دسکتاپ */}
        <motion.div
          className="flex flex-col w-full md:w-auto min-w-0 order-0 md:order-1"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* سمت چپ (دو باکس نمونه کار و درباره من) - دوم در موبایل، اول در دسکتاپ */}
        <div className="flex-1 flex flex-col gap-8 min-w-0 order-1 md:order-0">
          <Marquee />
