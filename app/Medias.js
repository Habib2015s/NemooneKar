...
export default function Medias() { useEffect(() => {
  ...
  return (
    <div className='flex justify-center gap-6 mt-11'>
      {/* کارت اول */}
      <div
        className='w-52 cursor-pointer shadow-3xl flex flex-col p-6 rounded-3xl 
      ...
      {/* کارت دوم */}
      <div
        className='w-2/3 cursor-pointer shadow-3xl flex flex-col p-6 rounded-3xl 
        bg-gradient-to-br from-[#FFDDE1] via-[#FF8F9B] to-[#21074b] 
        transform transition-transform duration-500 ease-in-out hover:scale-105 hover:shadow-4xl'
      >
